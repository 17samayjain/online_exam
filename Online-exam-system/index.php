...
<link rel="shortcut icon" href="btech.jpeg" type="x-icon" width="100%">
...
<img width="150px" height="150px" src="btech.jpeg">
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Very good iniative. I am so happy with the result!"<br><span>Pratik , Vice President, India</span></h4>
      </div>
      <div class="item">
        <h4>"One word... WOW!!"<br><span>John Doe, Salesman, ABC company</span></h4>
      </div>
      <div class="item">
        <h4>"Could I... BE any more happy with this startup"<br><span>Chandler Bing, Actor, Mumbai</span></h4>
      </div>
    </div>
